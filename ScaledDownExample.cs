...
/*This example has all row color modifications commented out and all downtime tracking removed.
  When reading from the PLC with the read logic that is here you must create a STRING[10] array in PLC.
  This program has the ISAUTO and CANREAD functions all bypassed to true so it will read the first time
  no matter what but wont read again unless tbsecond_item text is changed from PLC.
  */
...
namespace DataCollectionTest
{
    public partial class Form1 : Form
    {
        ...
        public bool InAuto = true;// only read from plc if machine is in auto
        ...
        private void SecTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                TimedMessageBox.Show("Time is messed up", "ERROR", 2000);
            }
        ...
        private void add_Columns()
        {
            ...
            dataGridView1.Columns[0].Name = "First_item";
            dataGridView1.Columns[0].Width = 145;
            dataGridView1.Columns[1].Name = "Second_item";//This is what we are checking to see if changed to write new data.
            dataGridView1.Columns[1].Width = 185;
            dataGridView1.Columns[2].Name = "Third_item";
            dataGridView1.Columns[2].Width = 100;
            dataGridView1.Columns[3].Name = "Fourth_item";
            dataGridView1.Columns[3].Width = 100;
            dataGridView1.Columns[4].Name = "Fifth_item";
            dataGridView1.Columns[4].Width = 100;
            dataGridView1.Columns[5].Name = "Sixth_item";
            dataGridView1.Columns[5].Width = 100;
            dataGridView1.Columns[6].Name = "Date";
            dataGridView1.Columns[6].Width = 200;
            dataGridView1.Columns[7].Name = "Eigth_item";
        ...
        //Change types is needed
        public DataTable getData()
        {
            DataTable dt = new DataTable();
            // table.TableName = tableName;
            dt.Columns.Add("Firstitem", typeof(string));
            dt.Columns.Add("Seconditem", typeof(string));
            dt.Columns.Add("Thirditem", typeof(string));
            dt.Columns.Add("Fourthitem", typeof(string));
            dt.Columns.Add("Fifthitem", typeof(string));
            dt.Columns.Add("Sixthitem", typeof(string));
            dt.Columns.Add("Date", typeof(DateTime));
            dt.Columns.Add("Eigthitem", typeof(string));


            //get data that is in textboxes--Must be same order as header columns
            dt.Rows.Add(tbFirst_item.Text.ToString(), tbSecond_item.Text.ToString(), tbThird_item.Text.ToString(), tbFourth_item.Text.ToString(), tbFifth_item.Text.ToString(), tbSixth_item.Text.ToString(), tbDate.Text = DateTime.Now.ToString(), tbEigth_item.Text.ToString());
        ...
        public void WritetoDGView()
        {
            ...
            try
            {
             
                {
                    ...
                    dataGridView1.Rows.Add(tbFirst_item.Text.ToString(), tbSecond_item.Text.ToString(), tbThird_item.Text.ToString(), tbFourth_item.Text.ToString(), tbFifth_item.Text.ToString(), tbSixth_item.Text.ToString(), tbDate.Text.ToString(), tbEigth_item.Text.ToString());
                    ...
                    foreach (DataGridViewRow row in dataGridView1.Rows)
                    {
                        ...
                        if (dataGridView1.Rows.Count - 1 > row.Index)
                        {
                            ...
                            foreach (DataGridViewCell cell in row.Cells)
                            {
                                ...
                                /*
                                 * Commented out the value check for certain columns to add color to them.
                                 * If you want to use then uncomment and change cell index to your liking.
                                 * */
        ...
        public void WritetoExcel()
        {
            ...
            try
            {
                ...
                if (shift1 == 1)
                {
                    ...
                    {
                        IXLWorksheet ws = wb.Worksheet("TestData");// Tab on excel sheets name.
            ...
            try
            {
                ...
                if (isAuto)
                {
                    ...
                    if (CanRead == true)
                    {
                        ...
                        {
                            Name = "DataReadPLC[0]",//PLC Tag Name ( array)
                            Gateway = Gateway,
                            Path = "1,0",
                            Protocol = Protocol.ab_eip,
                            PlcType = PlcType.ControlLogix,
                        ...
                        for (int i = 0; i < DataReadPLC.Value[i].Length; i++)
                            ...
                            // These were names of my text boxes on form.  Change to your names here.
                             tbFirst_item.Text = DataReadPLC.Value[0].ToString();// this is the PLC tag array we are reading from.
                             tbSecond_item.Text = DataReadPLC.Value[1].ToString();
                             tbThird_item.Text = DataReadPLC.Value[2].ToString();
                             tbFourth_item.Text = DataReadPLC.Value[3].ToString();
                             tbFifth_item.Text = DataReadPLC.Value[4].ToString();
                             tbSixth_item.Text = DataReadPLC.Value[5].ToString();
                             tbEigth_item.Text = DataReadPLC.Value[6].ToString();
                        ...
                        {
                            Name = "DataReadFromPLC",//PLC Tag Name
                            Gateway = Gateway,
                            Path = "1,0",
                            Protocol = Protocol.ab_eip,
                            PlcType = PlcType.ControlLogix,
        ...
        try
        {
            ...
            if (shift2EmailReady == 2) // Shift 2 email response
            {
               ...
               // ADD EMAIL NAMES HERE
                ...
                oCCRecip2.Add("test.name2@somewhere.com");
